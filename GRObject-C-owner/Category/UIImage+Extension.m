...
+ (UIImage *)gr_resizeImageWithName:(NSString *)imageName {
    return [self gr_resizeImageWithName:imageName edgeInsets:UIEdgeInsetsZero];
}

/**
 *  返回拉伸后的图片,指定拉伸位置
 */
+ (UIImage *)gr_resizeImageWithName:(NSString *)imageName edgeInsets:(UIEdgeInsets)edgeInsets {
